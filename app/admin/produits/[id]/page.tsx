        ...
        <div className="container flex h-16 items-center justify-between px-4">
          <Link href="/admin/dashboard" className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-muted-foreground">Modifier produit</span>
            </div>
          </Link>
          <AdminNav />
        </div>
      ...
      <main className="flex-1 bg-muted">
        <div className="container px-4 py-8">
          <div className="mx-auto max-w-3xl">
            <div className="mb-8">
              <h1 className="text-balance text-3xl font-bold tracking-tight">Modifier le produit</h1>
              <p className="text-muted-foreground">Mettez à jour les informations du bijou</p>
            </div>
